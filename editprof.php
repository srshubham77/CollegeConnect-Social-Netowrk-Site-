...
{
mysqli_query($con,"UPDATE stuacc SET firstname='$_POST[fname]',lastname='$_POST[lname]'
WHERE id= '$_SESSION[iduser]'");

mysqli_query($con,"UPDATE profile SET city ='$_POST[city]',	state='$_POST[state]',pincode='$_POST[pincode]',country='$_POST[loc]',hschool='$_POST[hschool]',coluni='$_POST[coll]',course='$_POST[hschool2]'
